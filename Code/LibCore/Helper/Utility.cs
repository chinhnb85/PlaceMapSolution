...
namespace LibCore.Helper
{
    public class Utility
    {
        ...
        /// <returns>MM-dd-yyyy H:m:s</returns>
        ...
        public static decimal FormatMoney(string money, int lang)
        {
            switch (lang)
            {
                case 0: //French
        ...
        public static string EncryptMd5(string Text, string Key = "chinhnb")
        {
        ...
        public static string DecryptMd5(string EncryptedText, string Key = "chinhnb")
        {
